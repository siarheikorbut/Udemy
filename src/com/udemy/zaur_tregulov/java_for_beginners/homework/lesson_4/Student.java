package com.udemy.zaur_tregulov.java_for_beginners.homework.lesson_4;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                student1.name +
                        ...
                        Math.round(sumAverageMarkSt1 * 100.0) / 100.0
        );
        System.out.println(
                student2.name +
                        " " +
                        student2.surname +
                        " : средняя арифметическая оценка = " +
                        Math.round(sumAverageMarkSt2 * 100.0) / 100.0
        );
        System.out.println(
                student3.name +
                        " " +
                        student3.surname +
                        " : средняя арифметическая оценка = " +
                        Math.round(sumAverageMarkSt3 * 100.0) / 100.0
        );
    }
}