 ...
 * целых чисел, передают эту сумму в output. В случае если слагаемые отсутствуют (т.е. когда
 * параметров нет) сумма должна равняться нулю. Продемонстрировать работу созданных методов в тестовом классе и
