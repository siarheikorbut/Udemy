 ...
 * В нём необходимо создать 3 разных обьекта класса Student и вывести в консоль в читабельном виде среднюю
 * арифметическую оценку каждого студента (учитывая все три параметра).
 */
