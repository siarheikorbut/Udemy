 ...
 * Создать два класса. 1-ый назовать Student. Он должен содержать в себе следующие атрибуты:
 * номер студенческого билета, имя, фамилию, год обучения, среднюю оценку по математике,
 * среднюю оценку по экономике, среднюю оценку по иностранному языку. Второй класс назвать StudentTest.
 * В нём необходимо создать метод для вычисления средней арифметической оценки по трем предметам. Создать
 * 3 разных обьекта класса Student и продемонстрировать на них работу созданного метода.
 */
